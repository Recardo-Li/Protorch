...
@register_tool
class SaProtTokenClassificationCaller(SaProtCaller):
    def __init__(self, **kwargs):
        super().__init__("saprot_token_classification", **kwargs)
...
if __name__ == "__main__":
    caller = SaProtTokenClassificationCaller()
    
    input_args = {
        "protein_sequence": "AAAAAAAAAA",
        "specific_task": "Model-Binding_Site_Detection-650M"
    }
