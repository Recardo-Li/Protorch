...
@register_tool
class SaProtPairRegressionCaller(SaProtCaller):
    def __init__(self, **kwargs):
        super().__init__("saprot_pair_regression", **kwargs)
...
if __name__ == "__main__":
    caller = SaProtPairRegressionCaller()
    
    input_args = {
        "protein1_sequence": "AAAAAAAAAA",
        "protein2_sequence": "AAAAAAAAAA",
        "specific_task": "Model-Structural_Similarity-650M"
    }
