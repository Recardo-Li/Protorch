...
@register_tool
class RFBinderCaller(BaseTool):
    def __init__(self, out_dir: str = f"{ROOT_DIR}/outputs/rfdiffusion_binder_design", **kwargs):
        super().__init__(
...
if __name__ == "__main__":
    caller = RFBinderCaller(out_dir=BASE_DIR)
    
    input_args = {
        "contigs": "100",
        "protein_structure": "example/4N5T.pdb",
        "num_designs": 3
    }
