...
@register_tool
class RFMotifCaller(BaseTool):
    def __init__(self, out_dir: str = f"{ROOT_DIR}/outputs/rfdiffusion_motif_scaffolding", **kwargs):
        super().__init__(
...
if __name__ == "__main__":
    caller = RFMotifCaller("agent/tools/rfdiffusion")
