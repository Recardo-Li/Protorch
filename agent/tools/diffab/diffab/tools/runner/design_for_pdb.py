...
ROOT_DIR = __file__.rsplit("/", 6)[0]
if ROOT_DIR not in sys.path:
    sys.path.append(ROOT_DIR)

from agent.tools.diffab.diffab.datasets.custom import preprocess_antibody_structure
from agent.tools.diffab.diffab.models import get_model
from agent.tools.diffab.diffab.modules.common.geometry import reconstruct_backbone_partially
from agent.tools.diffab.diffab.modules.common.so3 import so3vec_to_rotation
from agent.tools.diffab.diffab.utils.inference import RemoveNative
from agent.tools.diffab.diffab.utils.protein.writers import save_pdb
from agent.tools.diffab.diffab.utils.train import recursive_to
from agent.tools.diffab.diffab.utils.misc import *
from agent.tools.diffab.diffab.utils.data import *
from agent.tools.diffab.diffab.utils.transforms import *
from agent.tools.diffab.diffab.utils.inference import *
from agent.tools.diffab.diffab.tools.renumber import renumber as renumber_antibody
...
def design_for_pdb(args):
    ...
    logger.info('Loading model config and checkpoints: %s' % (args.model_dir))
...
def args_from_cmdline():
    ...
    parser.add_argument('-o', '--out_root', type=str, default='outputs/diffab')
