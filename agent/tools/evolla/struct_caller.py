...
@register_tool
class EvollaStruct(BaseTool):
    def __init__(self, out_dir: str = f"{ROOT_DIR}/outputs/evolla_chat_bystruct", **kwargs):
        super().__init__(
    ...
    def __call__(self, question, protein_structure) -> dict:
...
if __name__ == '__main__':
    # Test
    protein_chat_byid = EvollaStruct(f"{ROOT_DIR}/agent/tools/evolla")
    
    input_args = {
        "question": "What is the function of this protein?",
        "protein_structure": "example/P06213.pdb",
    }
