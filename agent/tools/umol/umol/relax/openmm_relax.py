...
def fix_pdb(
    ...
    mm_app.PDBFile.writeFile(fixer.topology, fixer.positions, open(os.path.join(outdir, file_name+'_hydrogen_added.pdb'), 'w'))
...
def minimize_energy(
    ...
    mm_app.PDBFile.writeFile(topology, minpositions, open(os.path.join(outdir, out_title+'.pdb'),'w'))
...
if __name__ == "__main__":
    ...
    ligand_mol.assign_partial_charges(partial_charge_method='formal_charge')
